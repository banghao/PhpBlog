                    ...
                    <aside class="left-side sidebar-offcanvas">
                        ...
                        <section class="sidebar">
                            ...
                            <ul class="sidebar-menu">
                                <li >
                                    <a href="xitongindex.do?method=0">
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                              <header class="panel-heading" style="background-color: #37474f;">
                                 <span style="font-family: '微软雅黑'; font-size: 25px; color: #F9F9F9;font-weight: bold;">教练列表:</span>
                              </header>
                              <div class="panel-body">
                                  <form class="form-horizontal tasi-form" method="get">
                                      ...
                                      <div class="form-group" style="position: relative;top: -8px; background-color:#607d8b;height:50px;text-align: center; font-size: 20px;color: #F9F9F9;">
                                          <div class="col-sm-3" style="position: relative; top:10px;" >
                                              <label>序号</label>
                                          </div>
                                          <div class="col-sm-3" style="position: relative; top:10px;" >
                                              <label>教练号</label>
		                              ...
		                              -->
                                      <%
                                          CoachDao coaDao = new CoachDao();
                                          List<Coach> coalist;
                                          coalist=coaDao.list();
                                          if (coalist.size() != 0) {
                                              for (int i = 0; i < coalist.size(); i++) {
                                                  Coach coa = coalist.get(i);
                                            %>

                                      <div class="form-group" style="background-color: #eceff1;font:'微软雅黑';font-size: 18px; text-align:center;">
                                          <label class="col-sm-3"><%=coa.getId()%></label>
                                          <a href="Stucoa.do?method=2&id=<%=coa.getId()%>"><label class="col-sm-3"><%=coa.getCoach()%></label>
	                                    	   <label class="col-sm-3"><%=coa.getCoachname()%></label>
	                                       <label class="col-sm-3"><%=coa.getType()%></label></a>
                                      </div>
                                      <%
                                              }
                                          }
