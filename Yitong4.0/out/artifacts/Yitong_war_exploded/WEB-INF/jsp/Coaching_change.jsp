...
<%@ page import="com.xc.dao.CoachinformDao" %>
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                              ...
                              <div class="panel-body">
                                  <form class="form-horizontal tasi-form" method="post" action="Stucoa.do?method=5&id=<%=coachinform.getId()%>" >
                                      ...
                                      <div class="form-group" style="font-size: 18px; position: relative; top: 30px;">
	                                          ...
	                                          <div class="col-md-7 form-group">
                                           		 <input name="coachname" type="text"  class="form-control"  placeholder="<%=coachinform.getCoachname()%>">
                                       		 </div>
	                                          
	                                          <label class="col-lg-5 col-sm-5 control-label">性   别：</label>

	                                          <div class="col-md-7 form-group">
                                           		 <input name="sex" type="text"  class="form-control"  placeholder="<%=coachinform.getSex()%>">
                                       		 </div>
	                                          <label  class="col-lg-5 col-sm-6 control-label">登录密码：</label>

	                                          <div class="col-md-7 form-group">
                                           		 <input name="password" type="text"  class="form-control" placeholder="<%=coachinform.getPassword()%>">
                                       		 </div>
	                                          <label class="col-lg-5 col-sm-5 control-label">身份证号：</label>

                                                <div class="col-md-7 form-group">
                                                    <input name="idcard" type="text"  class="form-control"  placeholder="<%=coachinform.getIdcard()%>">
                                                </div>

	                                          <label class="col-lg-5 col-sm-5 control-label">联系方式：</label>

	                                          <div class="col-md-7 form-group">
                                           		 <input name="phone" type="text"  class="form-control" value="<%=coachinform.getPhone()%>">
                                       		 </div>
	                                          <label class="col-lg-5 col-sm-5 control-label">家庭住址：</label>

	                                          <div class="col-lg-6">
	                                         		<textarea name="address" style="width: 300px; border: 1px #BDBDBD solid;" placeholder="<%=coachinform.getAddress()%>"></textarea>
	                                          </div>
	                                       </div > 
