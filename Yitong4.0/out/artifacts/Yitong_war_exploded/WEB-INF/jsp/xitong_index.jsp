                        ...
                        <div class="col-md-3">
                            <div class="sm-st clearfix">
                                ...
                                <div class="sm-st-info">
                                    <span>3200</span>
                                    <span style="font-size: 18px;">总任务</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="sm-st clearfix">
                                ...
                                <div class="sm-st-info">
                                    <span>2200</span>
                                    <span style="font-size: 18px;">总消息</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="sm-st clearfix">
                                ...
                                <div class="sm-st-info">
                                    <span>100,320</span>
                                    <span style="font-size: 18px;">总利润</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="sm-st clearfix">
                                ...
                                <div class="sm-st-info">
                                    <span>4567</span>
                                    <span style="font-size: 18px;">总访问人数</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                               ...
                                               通知：
                                                ...
                                                <div class="panel-body" id="noti-box">
                                                    ...
                                                    <div class="alert alert-block alert-danger">
                                                        ...
                                                        <strong>警 告！</strong> 信息更新失败，请重新上传！
                                                    </div>
                                                    <div class="alert alert-success">
                                                        <button data-dismiss="alert" class="close close-sm" type="button">
                                                            <i class="fa fa-times"></i>
                                                        </button>
                                                        <strong>成 功！</strong> 你成功阅读了重要信息！
                                                    </div>
                                                    <div class="alert alert-info">
                                                        <button data-dismiss="alert" class="close close-sm" type="button">
                                                            <i class="fa fa-times"></i>
                                                        </button>
                                                        <strong>有新状态!</strong> 有新的用户访问了易通驾校！
                                                    </div>
                                                    <div class="alert alert-warning">
                                                        <button data-dismiss="alert" class="close close-sm" type="button">
                                                            <i class="fa fa-times"></i>
                                                        </button>
                                                        <strong>错 误!</strong> 有用户访问数据库产生错误！
                                                    </div>
          ...
          <div class="col-md-4">
            <section class="panel">
              ...
              <!-- row end -->
                ...
                Copyright &copy  Json  2017-2018 design by xuchen、zhehan.lai、banghao.cheng   
                </div>
            </aside><!-- /.right-side -->
