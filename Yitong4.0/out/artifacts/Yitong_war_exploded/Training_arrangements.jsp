                    ...
                    <aside class="left-side sidebar-offcanvas">
                        ...
                        <section class="sidebar">
                            ...
                            <ul class="sidebar-menu">
                                ...
                                <li >
                                    <a href="../Student_information.html">
                                        <i class="fa fa-list"></i> <span>学员信息</span>
                                    </a>
                                </li>

                                <li >
                                    <a href="../Coaching_information.html">
                                        <i class="fa fa-align-justify"></i> <span>教练信息</span>
                                    </a>
                                </li>

                                <li class="active">
                                    <a href="Training_arrangements.html">
                                        <i class="fa fa-calendar"></i> <span>培训安排</span>
                                    </a>
                                </li>
								
								<li>
                                    <a href="../Examination_arrangement.html">
                              ...
                              <div class="panel-body">
                                  <form class="form-horizontal tasi-form" method="get">
                                      ...
                                      <div class="form-group" style="background-color: #eceff1;font:'微软雅黑';font-size: 12px; text-align:center;color: #616161;">
                                           <label class="col-sm-2">教练姓名</label>
                                           <label class="col-sm-2">学员姓名</label>
	                                    	   <label class="col-sm-4">学员住址</label>
	                                    	   <label class="col-sm-2">学员联系方式</label>
	                                       <label class="col-sm-2">教学科目</label>
                                      </div>
