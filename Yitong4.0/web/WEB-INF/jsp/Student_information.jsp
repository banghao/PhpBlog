                        ...
                        <div class="col-md-12">
                            <section class="panel">
                              <header class="panel-heading" style="background-color: #37474f;">
                                 <span style="font-family: '微软雅黑'; font-size: 25px; color: #F9F9F9;font-weight: bold;">学员列表:</span>
                              </header>
                              <div class="panel-body">
                                  <form class="form-horizontal tasi-form" method="get">
                                      ...
                                      <div class="form-group" style="background-color: #eceff1;font:'微软雅黑';font-size: 18px; text-align:center;">
                                           <a href="Student.do?method=1&id=<%=student.getStuID()%>"><label class="col-sm-4"><%=student.getStuID()%></label>
	                                    	   <label class="col-sm-4"><%=student.getStuname()%></label>
	                                       <label class="col-sm-4"><%=student.getStustate()%></label></a>
                                      </div>
                                      <%
                                              }
                                          }
