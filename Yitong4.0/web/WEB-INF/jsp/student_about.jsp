                            ...
                            <section class="panel">
                              ...
                              <div class="panel-body">
                                  <div class="form-horizontal tasi-form">
                                  	<div id="form-border" style="border: 2px solid;border-radius:25px; height:400px;width: 70%;margin: auto;">
                                      <div class="form-group" style="font-size: 18px; position: relative; top: 30px;">
                                              ...
                                              %>
	                                          <div class="col-lg-6">
	                                              <p class="form-control-static"><%=student.getStuname()%></p>
	                                          </div>
	                                          ...
	                                          -->
	                                          <div class="col-lg-6">
	                                              <p class="form-control-static"><%=student.getStusex()%></p>
	                                          </div>
	                                          <label class="col-lg-6 col-sm-6 control-label">培训阶段：</label>
	                                          <!--
	                                          	作者：来哲函
	                                          	时间：2018-01-06
	                                          ...
	                                          <label class="col-lg-6 col-sm-6 control-label">出生日期：</label>
	                                          <!--
	                                          	作者：来哲函
	                                          	时间：2018-01-06
	                                          ...
	                                          -->
	                                          <div class="col-lg-6">
	                                              <p class="form-control-static"><%=student.getStubrithday()%></p>
	                                          </div>
	                                          ...
	                                          -->
	                                          <div class="col-lg-6">
	                                              <p class="form-control-static"><%=student.getStuphone()%></p>
	                                          </div>
	                                          ...
	                                          -->
	                                          <div class="col-lg-6">
	                                              <p class="form-control-static"><%=student.getStuaddr()%></p>
	                                          </div>
	                                       </div > 
	                                       ...
	                                       <!--
	                                          ...
	                                          -->
	                                       <div class="col-lg-6">
	                                       		<button style="position: relative; left: 57%;top: 20px; width: 120px; border: none; color: white; padding: 15px 20px;border-radius: 12px; text-align:center; text-decoration: none; display:inline-block; font-weight:bold;font-size: 16px;background-color: #78909C;"><a style="color: white" href="Student.do?method=2&id=<%=student.getStuID()%>">修 改</a></button>
	                                       </div>
	                                       <!--
	                                          	作者：来哲函
	                                          	时间：2018-01-06
	                                          ...
	                                          -->
	                                       <div class="col-lg-6">
                                               <button style="position: relative; left: 10%;top: 20px; width: 120px; border: none; color: white; padding: 15px 20px;border-radius: 12px; text-align:center; text-decoration: none; display:inline-block; font-weight:bold;font-size: 16px;background-color: #78909C;"><a style="color: white" href="Student.do?method=3&id=<%=student.getStuID()%>">删 除</a></button>
	                                       </div>
                                      </div>
                                   </div>
                                  </div>
