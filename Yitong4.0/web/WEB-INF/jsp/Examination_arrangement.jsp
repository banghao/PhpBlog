<%@ page import="com.xc.dao.Test_arrangeDao" %>
<%@ page import="com.xc.model.Test_arrange" %>
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                              <header class="panel-heading" style="background-color: #37474f;">
                                 <span style="font-family: '微软雅黑'; font-size: 25px; color: #F9F9F9;font-weight: bold;">考试安排:</span>
                              </header>
                              <div class="panel-body">
                                  <form class="form-horizontal tasi-form" method="get">
		                              ...
		                              -->
                                      <%
                                          Test_arrangeDao test_arrangeDao = new Test_arrangeDao();
                                          List<Test_arrange> testlist;
                                          testlist=test_arrangeDao.list();
                                          if (testlist.size() != 0) {
                                              for (int i = 0; i < testlist.size(); i++) {
                                                  Test_arrange test_arrange = testlist.get(i);
                                      %>
                                      <div class="form-group" style="color: #616161;background-color: #eceff1;font:'微软雅黑';font-size: 10px; text-align:center;">
                                           <label class="col-sm-2"><%=test_arrange.getCoaname()%></label>
                                          <label class="col-sm-2"><%=test_arrange.getStuname()%></label>
	                                       <label class="col-sm-2"><%=test_arrange.getTestname()%></label>
	                                       <label class="col-sm-2"><%=test_arrange.getTesttime()%></label>
	                                       <label class="col-sm-4"><%=test_arrange.getTestfield()%></label>
                                      </div>
                                      <%
                                            }
                                          }
